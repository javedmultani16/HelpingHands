...
class JobSeekerHomeViewController: BaseVC {
        
        @IBOutlet weak var sliderCollectionView: UICollectionView!
        @IBOutlet weak var pageView: UIPageControl!
        
        var imgArr = [  UIImage(named:"s2") ,
                        UIImage(named:"c3") ,
                        UIImage(named:"s3") ,
                        UIImage(named:"s4") ,
                        UIImage(named:"c4") ,
    ...
    @IBAction func buttonHandlerTaskInvitation(_ sender: Any) {
    ...
    @IBAction func buttonHandlerCategories(_ sender: Any) {
    ...
    extension JobSeekerHomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    extension JobSeekerHomeViewController: UICollectionViewDelegateFlowLayout {
