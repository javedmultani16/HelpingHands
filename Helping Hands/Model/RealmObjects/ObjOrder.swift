...
public class ObjOrder: NSObject,NSCoding,Codable {
  ...
  private let kObjOrderPicKey: String = "Pic"
  ...
  */
  public init(json: JSON) {
    ...
    pic = json[kObjOrderPicKey].string
  ...
  */
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = pic { dictionary[kObjOrderPicKey] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.pic = aDecoder.decodeObject(forKey: kObjOrderPicKey) as? String
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(pic, forKey: kObjOrderPicKey)
